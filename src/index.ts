...
const dateStrSub = dateStr
  ...
  .split(':')
  .join('-');
const updateTimedLogger = fs.createWriteStream(`./logs/liquidator.updates.${pageStart}_${pageEnd}.${dateStrSub}.log`, {});
const actionTimedLogger = fs.createWriteStream(`./logs/liquidator.actions.${pageStart}_${pageEnd}.${dateStrSub}.log`, {});
